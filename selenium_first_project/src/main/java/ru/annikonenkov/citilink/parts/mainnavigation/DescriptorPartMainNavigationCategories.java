...
public class DescriptorPartMainNavigationCategories extends APartDescriptor {
    ...
    public final Element<PageMobileCatalog> PHONES_ELEMENT =
            new Element<>("PHONES_ELEMENT", "li.menu-item_cat_phones span a", By::cssSelector, ETypeOfElement.LINK, PageMobileCatalog::new);

    public final Element<IContainerWorker> COMPUTERS_ELEMENT = new Element<>("COMPUTERS_ELEMENT", "li.menu-item_cat_computer", By::cssSelector, ETypeOfElement.LINK);
    ...
    public final Element<IContainerWorker> TOOLS_ELEMENT = new Element<>("TOOLS_ELEMENT", "li.menu-item_cat_cottage_tools", By::cssSelector, ETypeOfElement.LINK);
    ...
    public final Element<IContainerWorker> SPORT_ELEMENT = new Element<>("SPORT_ELEMENT", "li.menu-item_cat_active_sport", By::cssSelector, ETypeOfElement.LINK);
