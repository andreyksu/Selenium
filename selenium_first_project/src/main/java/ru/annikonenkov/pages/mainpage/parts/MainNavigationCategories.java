...
public class MainNavigationCategories<T extends IPart<?>> extends Part<T> {

    private static String _nameOfCurrentPart = "Основная категория";

    public MainNavigationCategories(WebDriver driver, T owner) {
